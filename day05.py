...
def load_data(file):
    ...
    structured_input["s"] = [int(x)
                             for x in raw_input[0][0].split(": ")[1].split()]
    structured_input["ss"] = [[int(y) for y in x.split()]
                              for x in raw_input[1][1:]]
    structured_input["sf"] = [[int(y) for y in x.split()]
                              for x in raw_input[2][1:]]
    structured_input["fw"] = [[int(y) for y in x.split()]
                              for x in raw_input[3][1:]]
    structured_input["wl"] = [[int(y) for y in x.split()]
                              for x in raw_input[4][1:]]
    structured_input["lt"] = [[int(y) for y in x.split()]
                              for x in raw_input[5][1:]]
    structured_input["th"] = [[int(y) for y in x.split()]
                              for x in raw_input[6][1:]]
    structured_input["hl"] = [[int(y) for y in x.split()]
                              for x in raw_input[7][1:]]
